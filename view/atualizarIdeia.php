	...
	<?php
		  if((!isset ($_SESSION['email']) == true) and (!isset ($_SESSION['senha']) == true)) { 
			...
			echo "
				...
				<tr><td><input  class='form-control' type='text' id='id' name='id' value='$id' disabled='true'></td></tr>
				<th colspan='2'>Ideia</th>
				<tr><td colspan='2'><textarea  class='form-control' id='ideia' name='ideia' maxlength='5000' placeholder='Do que se trata a ideia detalhe bem aqui'>$ideia</textarea></td></tr>
				<th colspan='2'>Data de inserção</th>
				<tr><td><input class='form-control' id='datepicker' name='datepicker' type='text' value='$dataParaBancoMysql'></td></tr>
				...
				<tr><td><input class='form-control' type='text' id='frase' name='frase' value='$frase' size='50' maxlength='100'></td></tr>

				<tr><td><input id='bt_atualizar' type='submit' value='Atualizar'></td></tr>
	...
	<a href='#topo' class='topo'>Voltar ao topo</a><br><br>
