    ...
    <div id="localizaoSite">
        <div id="localizaoReduzido">
            <span id='topo' class="fontDouradaTahoma">Você está em:</span><span class=""> &nbsp;Editar Perfil</span>
        </div>
    </div>
    <br><br>
        ...
        if ((!isset($_SESSION['email']) == true) and ( !isset($_SESSION['senha']) == true)) {
            ...
            echo "
        			...
        			<form enctype='multipart/form-data' action='../controles/updatePerfil.php' method='POST' onsubmit='return validaCampos()'>
        				...
        				<tr><td><input class='form-control' type='text' id='nome' name='nome' value='$nome' size='50'></td></tr>

        				<th colspan='2'>Data de Nascimento</th>
        				<tr><td><input class='form-control' type='text' id='datepicker' name='datepicker' value='$dataParaBancoMysql'></td></tr>

        				<th colspan='2'>Telefone Celular</th>
        				<tr><td><input class='form-control' type='text' id='celular' name='celular' value='$telefone_celular'></td></tr>

        				<th colspan='2'>Telefone Fixo</th>
        				<tr><td><input class='form-control type='text' id='telfixo' name='telFixo' value='$telefone_fixo'></td></tr>

        				<th colspan='2'>Email</th>
        				<tr><td><input class='form-control' type='text' id='email' name='email' value='$email'></td></tr>

        				<th colspan='2'>Nova Senha</th>
        				<tr><td><input class='form-control' type='password' id='senha' name='senha' value=''></td></tr>
