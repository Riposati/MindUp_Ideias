	...
	<div id="localizaoSite">
			<div id="localizaoReduzido">
			    <span id="topo" class="fontDouradaTahoma">Você está em:</span><span class=""> &nbsp;Negociação da Ideia</span>
			</div>
			</div>
	<br><br>
		...
		if((!isset ($_SESSION['email']) == true) and (!isset ($_SESSION['senha']) == true)) { 
			...
			echo "
				...
				while($a = $resultado->fetch()){
					...
					echo "<p class='pergunta_negociacao'><img class='foto_perfil_usuario' src='../fotosUsuarios/$recebe_imagem_autor[0]' /> >> " . $a[0] . "<br><span style='float:right;'>Data de recebimento " . $dataParaBancoMysql . "</span></p>";
					if(strcmp($a[1],"")!=0)
					echo "<p class='resposta_negociacao'><img class='foto_perfil_usuario' src='../fotosUsuarios/$recebe_imagem_interessado[0]' /> >> " . $a[1] . "<br><span style='float:right;'>Data de recebimento " . $dataParaBancoMysql2 . "</span></p>";
					else{
