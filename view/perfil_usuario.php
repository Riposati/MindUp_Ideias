    ...
    <?php
        ...
        if ((!isset($_SESSION['email']) == true) and ( !isset($_SESSION['senha']) == true)) {
            ...
            echo '<meta http-equiv="refresh" content="0;URL=../view/login.php" />';
               ...
               echo"<div id='topo' class='div_logout'>
                        <br>
            ...
            if (isset($nome)) { /// Se o usuário abriu a sessão 
                ...
                echo "<div class='conteudoInternas_perfil'>";
                echo "
                <div id='informacoesUsuario_ver_perfil'>
                <img src='../fotosUsuarios/" . $nome[10] . "' id='previsualizar'>
                <br><br><h2>$nome[1]</h2><br><br>
                <!--<div class='form-group'> MindPosts aqui
                  <label for='status'>O que você está pensando hoje</label>
                ...
                /*echo " aqui pretendo mostrar os amigos deste usuário
                <div id='amigos'>
                    <h2>Amigos deste usuário</h2>
                </div>          
                 ";
                */
